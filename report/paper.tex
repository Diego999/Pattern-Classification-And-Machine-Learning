...
\begin{figure}[!ht]
\center
\subfigure[Histogram of different feature types. We can see that the first and second looks like a Poisson distribution (the second has maybe be transformed with negative sign) and the third one a Gaussian distribution.]{\includegraphics[width=2.6in]{figures/featuresType.jpg} \label{fig:featuresType}}
\hfill
\subfigure[Plot of the correlation of the features and the outputs. Some feature are highly correlated  whereas some have really low correlation.]{\includegraphics[width=2.6in]{figures/correlation.jpg} \label{fig:correlation}}
\hfill
\caption{}
\end{figure}
