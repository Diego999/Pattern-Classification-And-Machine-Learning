...
saveFile(err6_cls1, 'err6_cls1');
saveFile(err6_cls2, 'err6_cls2');
saveFile(err6_cls3, 'err6_cls3');
...
saveFile(err7_cls1, 'err7_cls1');
saveFile(err7_cls2, 'err7_cls2');
saveFile(err7_cls3, 'err7_cls3');
...
saveFile(err8_cls1, 'err8_cls1');
saveFile(err8_cls2, 'err8_cls2');
saveFile(err8_cls3, 'err8_cls3');
%%
...
err3 = openFile('err3', s);

err4 = sqrt((1/N)*( ...
            (size(X_cls1, 1)*(openFile('err4_cls1', s).^2)) ...
          + (size(X_cls2, 1)*(openFile('err4_cls2', s).^2)) ...
          + (size(X_cls3, 1)*(openFile('err4_cls3', s).^2)) ...
     ));
     
 
err5 = sqrt((1/N)*( ...
            (size(X_cls1, 1)*(openFile('err5_cls1', s).^2)) ...
          + (size(X_cls2, 1)*(openFile('err5_cls2', s).^2)) ...
          + (size(X_cls3, 1)*(openFile('err5_cls3', s).^2)) ...
     ));
 
err6 = sqrt((1/N)*( ...
        (size(X_cls1, 1)*(openFile('err6_cls1', s).^2)) ...
      + (size(X_cls2, 1)*(openFile('err6_cls2', s).^2)) ...
      + (size(X_cls3, 1)*(openFile('err6_cls3', s).^2)) ...
 ));

err7 = sqrt((1/N)*( ...
        (size(X_cls1, 1)*(openFile('err7_cls1', s).^2)) ...
      + (size(X_cls2, 1)*(openFile('err7_cls2', s).^2)) ...
      + (size(X_cls3, 1)*(openFile('err7_cls3', s).^2)) ...
 ));

err8 = sqrt((1/N)*( ...
        (size(X_cls1, 1)*(openFile('err8_cls1', s).^2)) ...
      + (size(X_cls2, 1)*(openFile('err8_cls2', s).^2)) ...
      + (size(X_cls3, 1)*(openFile('err8_cls3', s).^2)) ...
 ));
