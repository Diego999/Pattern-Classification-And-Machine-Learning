...
err4 = ratio_cls1*openFile('err4_cls1', s) + ratio_cls2*openFile('err4_cls2', s) + ratio_cls3*openFile('err4_cls3', s);
err5 = ratio_cls1*openFile('err5_cls1', s) + ratio_cls2*openFile('err5_cls2',s) + ratio_cls3*openFile('err5_cls3',s);
err6 = ratio_cls1*openFile('err6_cls1', s) + ratio_cls2*openFile('err6_cls2',s) + ratio_cls3*openFile('err6_cls3',s);
err7 = ratio_cls1*openFile('err7_cls1', s) + ratio_cls2*openFile('err7_cls2',s) + ratio_cls3*openFile('err7_cls3',s);
err8 = ratio_cls1*openFile('err8_cls1', s) + ratio_cls2*openFile('err8_cls2',s) + ratio_cls3*openFile('err8_cls3',s);
