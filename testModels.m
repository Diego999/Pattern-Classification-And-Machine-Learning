...
err5 = openFile('err5_cls1', s) + openFile('err5_cls2',s) + openFile('err5_cls3',s);
err6 = openFile('err6_cls1', s) + openFile('err6_cls2',s) + openFile('err6_cls3',s);

figure;
boxplot([err0' err0b' err1' err2' err3' err4' err5' err6']);
legend(findobj(gca,'Tag','Box'),'0 Constant model','0b Constant model per cluster', '1 Least squares', '2 + Normalization', '3 + per cluster', '4 + Dummy encoding', '- Dummy, + Polynomial', 'Dummy and Polynomial');