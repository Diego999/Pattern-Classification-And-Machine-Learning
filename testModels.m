...
figure;
boxplot([err0' err0b' err1' err2' err3']);
legend(findobj(gca,'Tag','Box'),'0 Constant model','0b Constant model per cluster', '1 Least squares', '2 + Normalization', '3 + per cluster');